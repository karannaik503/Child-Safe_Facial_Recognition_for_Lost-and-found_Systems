...
class VectorStore:
    ...
    def search_embeddings(self, embedding, top_k=5, similarity_threshold=SIMILARITY_THRESHOLD):
        """
...
def search_faiss(embedding, top_k=5, similarity_threshold=SIMILARITY_THRESHOLD):
    """
